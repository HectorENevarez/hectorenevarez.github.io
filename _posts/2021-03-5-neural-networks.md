...
classes: wide
excerpt: Neural Networks aren't as complicated as they seem. This post provides a comprehensive breakdown neural networks and implements them from scratch in python.
categories:
  - Blog
